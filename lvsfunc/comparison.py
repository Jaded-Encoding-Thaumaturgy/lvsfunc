...
def find_diff(
    ...
    **namedclips: vs.VideoNode,
    ...
    warnings.warn(
        "find_diff: This function is deprecated! Please use `FindDiff` instead!",
        DeprecationWarning,
    )

    if len(namedclips or clips) != 2:
        raise CustomValueError(
            "Must pass exactly 2 clips!", find_diff, len(namedclips or clips)
        )
