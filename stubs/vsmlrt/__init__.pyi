...
def DPIR(
    clip: vs.VideoNode, strength: SupportsFloat | vs.VideoNode | None, tiles: int | tuple[int, int] | None = ...,
    tilesize: int | tuple[int, int] | None = ..., overlap: int | tuple[int, int] | None = ...,
    model: Literal[0, 1, 2, 3] = ..., backend: backendT = ...
) -> vs.VideoNode: ...
...
def calc_tilesize(
    ...
    width: int, height: int, multiple: int, overlap_w: int, overlap_h: int
...
def inference(
    ...
    network_path: str, overlap: tuple[int, int],
