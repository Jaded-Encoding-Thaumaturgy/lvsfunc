...
# We can't directly inherit MutableMapping because Vapoursynth doesn't abide by
# the proper return types.
class VideoProps:
    ...
    # This isn't possible to properly express in the type system without
    # upstream changes.
    def get(self, key: str, default: typing.Optional[T] = None) -> typing.Union[T, None, _VideoPropsValue]: ...
    def pop(self, key: str, default: typing.Union[T, typing.Literal['_EMPTY']] = typing.Literal['_EMPTY']) -> typing.Union[T, _VideoPropsValue]: ...
...
class _Plugin_std_Unbound(Plugin):
    ...
    def Binarize(self, clip: "VideoNode", threshold: typing.Optional[SingleAndSequence[float]] = None, v0: typing.Union[typing.Sequence[float], None] = None, v1: typing.Union[typing.Sequence[float], None] = None, planes: typing.Optional[SingleAndSequence[int]] = None) -> "VideoNode": ...
    ...
    def Convolution(self, clip: "VideoNode", matrix: typing.Sequence[float], bias: typing.Union[float, None] = None, divisor: typing.Union[float, None] = None, planes: typing.Optional[SingleAndSequence[int]] = None, saturate: typing.Union[int, None] = None, mode: typing.Union[str, bytes, bytearray, None] = None) -> "VideoNode": ...
    ...
    def Expr(self, clips: SingleAndSequence["VideoNode"], expr: SingleAndSequence[typing.Union[str, bytes, bytearray]], format: typing.Union[int, None] = None) -> "VideoNode": ...
    def FlipHorizontal(self, clip: "VideoNode") -> "VideoNode": ...
    def FlipVertical(self, clip: "VideoNode") -> "VideoNode": ...
    def FrameEval(self, clip: "VideoNode", eval: typing.Callable[..., typing.Any], prop_src: typing.Optional[SingleAndSequence["VideoNode"]] = None) -> "VideoNode": ...
    ...
    def Limiter(self, clip: "VideoNode", min: typing.Optional[SingleAndSequence[float]] = None, max: typing.Union[typing.Sequence[float], None] = None, planes: typing.Union[typing.Sequence[int], None] = None) -> "VideoNode": ...
    ...
    def MaskedMerge(self, clipa: "VideoNode", clipb: "VideoNode", mask: "VideoNode", planes: typing.Optional[SingleAndSequence[int]] = None, first_plane: typing.Union[int, None] = None, premultiplied: typing.Union[int, None] = None) -> "VideoNode": ...
    def Maximum(self, clip: "VideoNode", planes: typing.Optional[SingleAndSequence[int]] = None, threshold: typing.Union[float, None] = None, coordinates: typing.Union[typing.Sequence[int], None] = None) -> "VideoNode": ...
    ...
    def Prewitt(self, clip: "VideoNode", planes: typing.Optional[SingleAndSequence[int]] = None, scale: typing.Union[float, None] = None) -> "VideoNode": ...
    ...
    def SetFrameProp(self, clip: "VideoNode", prop: typing.Union[str, bytes, bytearray], delete: typing.Union[int, None] = None, intval: typing.Optional[SingleAndSequence[int]] = None, floatval: typing.Optional[SingleAndSequence[float]] = None, data: typing.Optional[SingleAndSequence[typing.Union[str, bytes, bytearray]]] = None) -> "VideoNode": ...
...
class _Plugin_std_Bound(Plugin):
    ...
    def Binarize(self, threshold: typing.Optional[SingleAndSequence[float]] = None, v0: typing.Union[typing.Sequence[float], None] = None, v1: typing.Union[typing.Sequence[float], None] = None, planes: typing.Optional[SingleAndSequence[int]] = None) -> "VideoNode": ...
    ...
    def Convolution(self, matrix: typing.Sequence[float], bias: typing.Union[float, None] = None, divisor: typing.Union[float, None] = None, planes: typing.Optional[SingleAndSequence[int]] = None, saturate: typing.Union[int, None] = None, mode: typing.Union[str, bytes, bytearray, None] = None) -> "VideoNode": ...
    ...
    def Expr(self, expr: SingleAndSequence[typing.Union[str, bytes, bytearray]], format: typing.Union[int, None] = None) -> "VideoNode": ...
    def FlipHorizontal(self) -> "VideoNode": ...
    def FlipVertical(self) -> "VideoNode": ...
    def FrameEval(self, eval: typing.Callable[..., typing.Any], prop_src: typing.Optional[SingleAndSequence["VideoNode"]] = None) -> "VideoNode": ...
    ...
    def Levels(self, min_in: typing.Union[typing.Sequence[float], None] = None, max_in: typing.Union[typing.Sequence[float], None] = None, gamma: typing.Union[typing.Sequence[float], None] = None, min_out: typing.Union[typing.Sequence[float], None] = None, max_out: typing.Union[typing.Sequence[float], None] = None, planes: typing.Union[typing.Sequence[int], None] = None) -> "VideoNode": ...
    def Limiter(self, min: typing.Optional[SingleAndSequence[float]] = None, max: typing.Union[typing.Sequence[float], None] = None, planes: typing.Union[typing.Sequence[int], None] = None) -> "VideoNode": ...
    ...
    def MaskedMerge(self, clipb: "VideoNode", mask: "VideoNode", planes: typing.Optional[SingleAndSequence[int]] = None, first_plane: typing.Union[int, None] = None, premultiplied: typing.Union[int, None] = None) -> "VideoNode": ...
    def Maximum(self, planes: typing.Optional[SingleAndSequence[int]] = None, threshold: typing.Union[float, None] = None, coordinates: typing.Union[typing.Sequence[int], None] = None) -> "VideoNode": ...
    ...
    def Prewitt(self, planes: typing.Optional[SingleAndSequence[int]] = None, scale: typing.Union[float, None] = None) -> "VideoNode": ...
    ...
    def SetFrameProp(self, prop: typing.Union[str, bytes, bytearray], delete: typing.Union[int, None] = None, intval: typing.Optional[SingleAndSequence[int]] = None, floatval: typing.Optional[SingleAndSequence[float]] = None, data: typing.Optional[SingleAndSequence[typing.Union[str, bytes, bytearray]]] = None) -> "VideoNode": ...
